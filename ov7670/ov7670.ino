...
#define MEM_WEN _BV(PINH3)
#define MEM_RRST _BV(PINH4)
#define MEM_WRST _BV(PINH5)
#define MEM_RCK _BV(PINH6)

/* FIFO Calls */

#define WRITE_ENABLE PORTH |= MEM_WEN
#define WRITE_DISABLE PORTH &= ~(MEM_WEN)

#define READ_CLOCK_HIGH PORTH |= MEM_RCK
#define READ_CLOCK_LOW PORTH &= ~(MEM_RCK)

#define READ_RESET_HIGH PORTH |= MEM_RRST
#define READ_RESET_LOW PORTH &= ~(MEM_RRST)

#define WRITE_RESET_HIGH PORTH |= MEM_WRST
#define WRITE_RESET_LOW PORTH &= ~(MEM_WRST)
...
static struct regval_list ov7670_qqvga[] PROGMEM = {
{ REG_HSTART, 0x16 },
{ REG_HSTOP,	0x04 },
{ REG_HREF, 0x24 },
{ REG_VSTART, 0x02 },
...
static struct regval_list ov7670_fmt_yuv422[] PROGMEM = {
{ REG_RGB444, 0 },
...
static struct regval_list ov7670_fmt_rgb565[] PROGMEM = {
{ REG_RGB444, 0 },
...
static struct regval_list ov7670_default[] PROGMEM = {
    //--------------------------------------------------------------------------
    // Gamma curve values
    //--------------------------------------------------------------------------
    { 0x7a, 0x20 },         { 0x7b, 0x10 },
...
READ_CLOCK_HIGH;
        b = PINA;
//b = (PINC & B00001111) | (PIND & B11110000);
READ_CLOCK_LOW;
